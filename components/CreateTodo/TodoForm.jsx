...
export default function TodoForm({handleChangeModalState, todo, handleKeyUpdate}){
    const [startDate, setStartDate] = useState(new Date());
    const { handleNewTodo } = useContext(StoreContext);
    ...
    const onSubmit = (input, e) => {
        ...
        if(todo){
            ...
            handleNewTodo(input.title, startDate, input.description);
        }
    };
